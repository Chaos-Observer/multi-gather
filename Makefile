LIB = periphery.a
SRCS = periphery/src/gpio.c periphery/src/gpio_cdev_v2.c periphery/src/gpio_cdev_v1.c periphery/src/gpio_sysfs.c periphery/src/led.c periphery/src/pwm.c periphery/src/spi.c periphery/src/i2c.c periphery/src/mmio.c periphery/src/serial.c periphery/src/version.c

SRCDIR = src
OBJDIR = obj

TEST_PROGRAMS = $(basename $(wildcard ./*.c))
